...
public class IdWorker {
     ...
     * 开始时间截 (2018-12-13)
     */
    private final long twepoch = 1544630400000L;
    ...
    private static class SingletonIdWorker {

        private static IdWorker singleton = new IdWorker(workerId, datacenterId);
    }
    ...
    public static IdWorker getInstance(long workerId, long datacenterId) {
        ...
        return SingletonIdWorker.singleton;
    }
        ...
        for (int i = 0; i < 100; i++) {
            ...
            new Thread(){
                ...
                public void run() {
                    ...
                    long id = IdWorker.getInstance(1,1).nextId();
                    //System.out.println("对象地址:" + IdWorker.getInstance(1, 1));
