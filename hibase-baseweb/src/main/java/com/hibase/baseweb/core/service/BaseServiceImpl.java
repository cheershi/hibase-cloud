...
import com.hibase.baseweb.annotation.service.RelevanceFill;
import com.hibase.baseweb.annotation.mybatis.UniqueKey;
import com.hibase.baseweb.config.help.GenerateIdHelper;
import com.hibase.baseweb.constant.web.GlobalConstant;
import com.hibase.baseweb.core.exception.BusinessException;
import com.hibase.baseweb.core.exception.entity.EntitySaveException;
import com.hibase.baseweb.core.exception.entity.EntityUniqueKeyException;
import com.hibase.baseweb.core.exception.entity.EntityValidException;
...
import com.hibase.baseweb.core.web.RelevanceFillProperties;
import com.hibase.baseweb.core.web.UniqueKeyPropertis;
...
public abstract class BaseServiceImpl<M extends BaseMapper<T>, T extends BaseDO> implements BaseService<T> {
    ...
    private Map<String, Object> buildMap(Map<String, UniqueKeyPropertis> propertisMap) {
        ...
        if (CollUtil.isNotEmpty(propertisMap)) {
    ...
    public boolean deleteBy(Collection<? extends Serializable> ids, boolean throwException) {
        ...
        boolean checkResult = CollUtil.isEmpty(results) || results.size() != ids.size();
